...
public class PostFishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectImage = (ImageButton)findViewById(R.id.btnImagePostFish);
        mPostTitle = (EditText)findViewById(R.id.etFishPostTitle);
        mPostDes = (EditText)findViewById(R.id.etFishPostDesc);
    ...
    private void startPosting() {
        ...
        if(!TextUtils.isEmpty(title_val)&&!TextUtils.isEmpty(desc_val)&&imageUri!= null ){
            mProgress.show();
                ...
                StorageReference filePath = mStorage.child("Fish").child(imageUri.getLastPathSegment());
                filePath.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        newPost.child("fishPoatTitle").setValue(title_val);
                        newPost.child("fishPostDescription").setValue(desc_val);
                        newPost.child("fishPostImage").setValue(downloadUri.toString());
                        mProgress.dismiss();
                        startActivity(new Intent(PostFishActivity.this, FishActivity.class));
                    }
                });
