...
public class PostProActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectImage = (ImageButton)findViewById(R.id.btnImagePostPro);
        mPostTitle = (EditText)findViewById(R.id.etProPostTitle);
        mPostDes = (EditText)findViewById(R.id.etProPostDesc);
...
//                        .setAction("Action", null).show();
    ...
    private void startPosting() {
        ...
        if(!TextUtils.isEmpty(title_val)&&!TextUtils.isEmpty(desc_val)&&imageUri!= null ){
            mProgress.show();
            StorageReference filePath = mStorage.child("Projokty").child(imageUri.getLastPathSegment());
            filePath.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    newPost.child("proPostTitle").setValue(title_val);
                    newPost.child("proPostDescription").setValue(desc_val);
                    newPost.child("proPostImage").setValue(downloadUri.toString());
                    mProgress.dismiss();
                    startActivity(new Intent(PostProActivity.this, ProjoktyActivity.class));
                }
            });
        }
    }
