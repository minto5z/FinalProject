...
public class ProDetailsActivity extends AppCompatActivity {
    ...
    private ArrayList<PostProjokty> mRestaurants = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pro_details);

        mTitle = (TextView) findViewById(R.id.detailsProTitle);
        mDesc = (TextView)findViewById(R.id.detailsProDesc);
        mImage = (ImageView)findViewById(R.id.detailsProImage);
        ...
        String name = mRestaurants.get(startingPosition).getproPostTitle();
        String description = mRestaurants.get(startingPosition).getproPostDescription();
        String image = mRestaurants.get(startingPosition).getproPostImage();
